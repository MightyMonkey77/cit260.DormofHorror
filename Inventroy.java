 ...
 */
package BYUI.CIT260.Dormofhorror.model;
 ...
 * @author RJrHerrera
 */
public class Inventroy implements Serializable{
    ...
    public String toString() {
        return "Inventroy{" + "inventoryType=" + inventoryType + ", quantityInStock=" + quantityInStock + ", maxAmount=" + maxAmount + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Inventroy other = (Inventroy) obj;
